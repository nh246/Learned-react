function NewsLetter() {
  return (
    <div className="bg-[#2699fb] p-4 flex justify-between ">
      <div className="max-w-[1240px] py-[40px] mx-5 ">
        <h1 className="font-bold text-white text-[30px]">Want to learn IT Skills ?</h1>
        <p className="text-white text-[15px]">Sign up to our newsletter and stay up to date.</p>
      </div>
